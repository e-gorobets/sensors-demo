...
public class MqttConfig {
    ...
    public MqttClient mqttClient() throws Exception {
        String broker = "ssl://mqtt.cloud.yandex.net:8883"; // MQTT брокер Яндекса
        String clientId = "SensorDataPublisher";

        MqttClient mqttClient = new MqttClient(broker, clientId);

        MqttConnectOptions options = new MqttConnectOptions();
        options.setUserName("a448rfjcmhug9mp2ht4i"); // Замените на ваш client ID
        options.setPassword("Oa72Sj2158ASfgJ2i".toCharArray()); // Замените на ваш client secret
